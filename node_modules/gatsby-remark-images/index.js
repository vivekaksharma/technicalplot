...
module.exports = function (_ref, pluginOptions) {
  ...
  var getNodeTitle = function getNodeTitle(node, alt) {
    if (node.title) {
      return node.title;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 44:
              ...
              showCaptions = options.showCaptions && getNodeTitle(node, alt);
              ...
              if (showCaptions) {
                rawHTML = ("\n  <figure class=\"gatsby-resp-image-figure\" style=\"" + wrapperStyle + "\">\n    " + rawHTML + "\n    <figcaption class=\"gatsby-resp-image-figcaption\">" + getNodeTitle(node, alt) + "</figcaption>\n  </figure>\n      ").trim();
              }
